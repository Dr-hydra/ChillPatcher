...
- 详细文档: [Bilibili 模块 README](../../../OmniMixPlayer/modules/Bilibili/README.md)
...
- 详细文档: [QQ 音乐模块 README](../../../OmniMixPlayer/modules/QQMusic/README.md)
...
- 详细文档: [网易云模块 README](../../../OmniMixPlayer/modules/Netease/README.md)

#### Spotify 音乐模块

- **🔐 OAuth 登录**：浏览器授权，无需密码
- **🎵 播放列表同步**：自动加载收藏歌曲和歌单
- **📱 Spotify Connect**：手机/桌面客户端远程控制播放
- **🎧 原生 PCM 解码**：基于 librespot (Rust)，输出交错 float32 PCM
- 详细文档: [Spotify 模块 README](../../../OmniMixPlayer/modules/Spotify/README.md)
...
项目根目录/
├── OmniMixPlayer/
│   ├── OmniMixPlayer.SDK/       ← **新 SDK**，所有模块开发使用此 SDK
│   ├── OmniMixPlayer.Backend/   ← 后台服务（ASP.NET Core）
│   └── modules/                 ← 音乐源模块
│       ├── LocalFolder/
│       ├── Netease/
│       ├── QQMusic/
│       ├── Bilibili/
│       └── Spotify/
├── mods/chillPatcher/src/
│   ├── ChillPatcher.SDK/        ← **已废弃**，仅保留兼容性空壳
│   ├── Patches/                 ← Harmony 补丁
│   ├── UIFramework/             ← UI 框架扩展
│   ├── Integration/             ← 自习室等集成功能
│   └── Native/                  ← 原生互操作封装
└── NativePlugins/               ← 原生插件（FLAC 解码器、OmniPcmShared 等）
```

### SDK 开发

> ⚠️ **ChillPatcher.SDK 已废弃**，仅保留兼容性空壳。所有新模块请使用 OmniMixPlayer.SDK。

详细文档请参见：

- **[OmniMixPlayer.SDK 模块开发指南](../../../OmniMixPlayer/OmniMixPlayer.SDK/README.md)** — 新 SDK 完整开发文档
- **[ChillPatcher.SDK (已废弃)](ChillPatcher.SDK/README.md)** — 旧 SDK 兼容性说明和迁移指南
