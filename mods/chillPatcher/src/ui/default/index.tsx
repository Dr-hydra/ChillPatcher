  ...
  render() {
    if (this.state.error) {
      return (
        ...
        >
          <div style={{ color: "#ff8888", fontSize: 12, marginBottom: 4 }}>
            [{this.props.name}] Error:
          </div>
          <div style={{ color: "#ffaaaa", fontSize: 10, whiteSpace: "Normal" }}>
            {this.state.error}
          </div>
        </div>
      );
...
const App = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: 16, color: theme.accent }}>ChillPatcher</div>
        <div
          style={{
            flexDirection: "Row",
            display: "Flex",
            ...
            tabs={[
              {
                ...
                label: "游戏API",
                content: () => (
                  <ErrorBoundary name="GameApiTestPanel">
                    <GameApiTestPanel />
                  </ErrorBoundary>
                ),
              },
              {
                ...
                label: "存档",
                content: () => (
                  <ErrorBoundary name="SaveProfilePanel">
                    <SaveProfilePanel />
                  </ErrorBoundary>
                ),
              },
              {
                ...
                label: "场景树",
                content: () => (
                  <ErrorBoundary name="UIExplorerPanel">
                    <UIExplorerPanel />
                  </ErrorBoundary>
                ),
              },
              {
                ...
                label: "输入法",
                content: () => (
                  <ErrorBoundary name="IMESettingsPanel">
                    <IMESettingsPanel />
                  </ErrorBoundary>
                ),
              },
              ...
              },
              {
                ...
                label: "许可证",
                content: () => (
                  <ErrorBoundary name="LicensesPanel">
                    <LicensesPanel />
                  </ErrorBoundary>
                ),
              },
