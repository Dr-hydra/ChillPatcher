...
#Region "基础请求引擎"
    ...
    Private Function DNSLookup(Request As HttpRequestMessage, CancelToken As CancellationToken) As String
        ...
        End If
        '选择可靠度最高的 IP
        Dim Target As IPAddress = MeloongCore.Extensions.EnumerableExtensions.MaxBy(Candidates, Function(i) Reliabilities(i))
...
#End Region
        ...
        Public Overrides Sub Start(Optional Input As Object = Nothing, Optional IsForceRestart As Boolean = False)
            ...
            '去重
            Files = New ConcurrentList(Of NetFile)(MeloongCore.Extensions.EnumerableExtensions.DistinctBy(Files, Function(a) a.LocalPath))
            '设置剩余文件数
        ...
        Private Function CheckExistingFile(FolderList As List(Of String), VersionFolders As List(Of String), File As NetFile) As String
            ...
            If Not TypeIndexes.Any Then
                ...
                End If
            End If
            Dim Type = MeloongCore.Extensions.EnumerableExtensions.MaxBy(TypeIndexes, Function(kv) kv.Item2).FolderName.TrimStart("\"c)
            '根据类别进行查找
