...
namespace OmniMixPlayer.Module.Netease
{
    ...
    public class NeteaseAccountApi : ICustomJSApi
    {
        ...
        public NeteaseAccountApi(NeteaseSessionManager sessionManager, ILogger logger)
        {
        ...
        public void login()
        {
            _logger.LogInformation("[NeteaseAccountApi] Manual login triggered from UI");
            _sessionManager.TriggerQRLogin();
        }

        public void logout()
        {
            _logger.LogInformation("[NeteaseAccountApi] Logout triggered from UI");
        ...
        {
            _logger.LogInformation("[NeteaseAccountApi] Manual session refresh triggered");
