    ...
    public class NeteaseLyricApi : ICustomJSApi
    {
        ...
        public string getSongLyric(string uuid)
        {
            ...
            try
            {
                ...
                _logger?.LogInformation($"[LyricNeteaseApi] Getting lyric for songId={songId} (uuid={uuid})");
                ...
                _logger?.LogInformation($"[LyricNeteaseApi] Got lyric for songId={songId}, length={result.Length}");
                return result;
            }
