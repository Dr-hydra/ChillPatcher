...
using OmniMixPlayer.Module.LocalFolder.Services.Database;

namespace OmniMixPlayer.Module.LocalFolder.Services
{
    /// <summary>
    /// 本地模块数据库 - 统一访问入口
    /// </summary>
    public class LocalDatabase : IDisposable
    {
        ...
        public LocalDatabase(string dbPath, ILogger logger)
        {
